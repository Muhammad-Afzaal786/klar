  ...
  <div>
   ...
   <div className="container-fluid lnding_container">
    <div className="row">
     ...
     <div
      className="col-lg-8 col-md-8 col-sm-8 col-xs-12 colDiv6"
      style={{ backgroundColor: "#B0B5b7", padding: "0px" }}
     >
      <div className="encounter__div ">
       <div className="encounter-row">
        <Link to="/select" style={{ textDecoration: "none" }}>
         <div className="d-flex justify-content-center align-items-center cont_div">
          <GoArrowLeft className="arrow_icon" />
          <h2 className="countrDiv">Continue Encounter? </h2>
          <GoArrowLeft className="arrow_icon" />
         </div>
        </Link>
        <Link to="/instruction" style={{ textDecoration: "none" }}>
         <div className="d-flex justify-content-center align-items-center cont_div2">
          <GoArrowRight className="arrow_icon" />
          <h2 className="countrDiv2">End Encounter? </h2>
          <GoArrowRight className="arrow_icon" />
         </div>
        </Link>
       </div>
